...
(function getDbConnection() {
    console.log('Initializing Cloudant connection for DJC...', 'getDbConnection()');
 ...
 */
function find(type, partialName, contact, userID) {
...
function create(type, name, description, quantity, location, contact, userID) {
    ...
    //console.log('Create: ' + type + ' ' + description + ' ' + userID);
...
function update(id, type, name, description, quantity, location, contact, userID) {
    ...
    //console.log('Update: ' + type + ' ' + quantity + ' ' + userID);
